...
public:
    // Constructors
    Student() : rId(""), fName(""), lName(""), classes(""), mNumber("") {}
    Student(const string& regId, const string& firstName, const string& lastName,
            const string& studentClass, const string& mobileNumber)
        : rId(regId), fName(firstName), lName(lastName), classes(studentClass), mNumber(mobileNumber) {}
