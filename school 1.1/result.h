...
public:
    // Constructors
    Result() : rId(""), classes(""), kannada(""), english(""), maths(""), science(""), sStudy("") {}
    Result(const string& regId, const string& studentClass, const string& kannadaScore,
           const string& englishScore, const string& mathsScore, const string& scienceScore, const string& sStudyScore)
        : rId(regId), classes(studentClass), kannada(kannadaScore), english(englishScore),
          maths(mathsScore), science(scienceScore), sStudy(sStudyScore) {}
...
void result::overAllClassResult()
{
    string classes;
