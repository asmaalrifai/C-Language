...
public:
    // Constructors
    Staff() : id(""), fName(""), lName(""), qualification(""), mNumber(""), pay("") {}
    Staff(const string& staffId, const string& firstName, const string& lastName,
          const string& staffPay, const string& staffQualification, const string& mobileNumber)
        : id(staffId), fName(firstName), lName(lastName), pay(staffPay),
          qualification(staffQualification), mNumber(mobileNumber) {}
